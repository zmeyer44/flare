...
export default function VideoPlayer({
  ...
  return (
    <MediaPlayer
      className="bg-muted-background group relative aspect-video h-auto w-full overflow-hidden rounded-md font-sans text-foreground ring-media-focus data-[focus]:ring-4"
      title={title}
      src={src}
      crossorigin
      playsinline
