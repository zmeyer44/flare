  ...
  return (
    <div className="flex gap-6">
      <div className="flex-1">
        {/* Video Player */}
        <div className="aspect-video min-h-[400px] rounded-xl bg-orange-400">
          <Player />
        </div>
        <div className="pt-1">
            ...
            >
              ...
              <div className="text-sm text-muted-foreground">
                <p>
                  ...
                  Ipsam tenetur sit officiis quibusdam inventore recusandae
                  adipisci perspiciatis? Id, nostrum. Sequi laudantium cumque
                  quibusdam id autem odio doloribus minima fugit neque!
                </p>
              </div>
